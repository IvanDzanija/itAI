    ...
    def train(self, train_features, train_target, num_iterations, print_interval=2000):
        for iteration in range(num_iterations):
            ...
            if (iteration + 1) % print_interval == 0:
                ...
                train_error = best_individual.calculate_error(
...
def main():
    parser = argparse.ArgumentParser(
        description="Genetic algorithm for neural network."
    )
    ...
    parser.add_argument(
        "--popsize", type=int, help="Population size for genetic algorithm"
    )
    parser.add_argument(
        "--elitism", type=int, help="Number of best individuals to preserve"
    )
    ...
    parser.add_argument(
        "--iter", type=int, help="Number of iterations for genetic algorithm"
    )
